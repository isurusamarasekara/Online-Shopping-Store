<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import=" com.dao.searchBox.SearchDAO, java.text.DecimalFormat, java.sql.ResultSet"%>
			...
			%>
				<h3>${Category} </h3>
					...
					<%
						...
						ResultSet rst = SearchDAO.Search(search,category);
					...
					%>
						<div class="well well-small">
							<div class="row-fluid">	  
								<div class="span2">
									<img src="<%=rst.getString(4) %>" alt="">
								</div>
								<div class="span6">
									<h4><%=rst.getString(3) %> [<%=rst.getString(5) %>]</h4>
									<p>	<%=rst.getString(6) %></p>
								</div>
							</div>
						</div>
